...
export function drawCarVectorPreview(ctx: CanvasRenderingContext2D, customization: CarCustomization) {
  ...
  if (decal !== 'none') {
    ...
    if (decal === 'stripes') {
      ...
      ctx.lineWidth = 3.5;
      ctx.beginPath();
      // Draw parallel racing lines on the car body
      ...
      ctx.fillStyle = grad;
      ctx.beginPath();
      // Draw aggressive fire flames licking along the side/hood
      ctx.moveTo(-halfW * 0.2, halfH * 0.25);
      ctx.quadraticCurveTo(halfW * 0.2, -halfH * 0.2, halfW * 0.5, -halfH * 0.1);
      ...
      ctx.quadraticCurveTo(0, halfH * 0.5, -halfW * 0.2, halfH * 0.25);
      ctx.fill();
      ...
      ctx.lineWidth = 2.5;
      ctx.beginPath();
      // High frequency zig-zag cyber lightning bolt
      ...
      ctx.lineWidth = 3;
      ctx.beginPath();
      // Swooping martial-arts curve patterns
      ctx.moveTo(-halfW * 0.5, halfH * 0.1);
