    ...
    <div className="pointer-events-none absolute inset-0 z-30 flex items-center justify-center select-none">
      ...
      <AnimatePresence>
        {goalEvent && !matchWinner && (
          ...
          >
            <div
              className={`rounded-3xl border-2 px-12 py-5 shadow-2xl backdrop-blur-xl ${
                goalEvent.scoringTeam === 'blue'
                  ? 'border-blue-400 bg-blue-950/90 shadow-[0_0_50px_rgba(59,130,246,0.8)]'
                  : 'border-orange-400 bg-orange-950/90 shadow-[0_0_50px_rgba(249,115,22,0.8)]'
              }`}
            >
              <div className="flex flex-col items-center text-center">
                {/* Huge BUT text */}
                <h1 className="font-display text-7xl font-black italic tracking-tight text-white drop-shadow-[0_0_20px_rgba(255,255,255,0.8)]">
                  BUT !
                </h1>
