...
import { loadPlayerProfile, savePlayerProfile, getRankTier } from './utils/profileStorage';
...
export default function App() {
  ...
  // Player Profile state (Starts at 0 and completes as you play)
  ...
  // Car Customization state with local storage persistence
  ...
  return (
    <main className={`fixed inset-0 h-[100dvh] w-full overflow-hidden bg-slate-950 font-rajdhani text-white select-none ${currentScreen === 'game' ? 'touch-none' : 'overflow-y-auto'}`}>
